...
# ═══════════════════════════════════════════════════════════════
BOT_TOKEN        = "8742801995:AAFKK14AcbJoNT-w3TGosI1EzWLposjAyPE"   # @BotFather token
...
async def force_name_lock(page, gc_name: str):
    try:
        ...
        opened = await _try_click(page, [
            ...
            'div[role="button"][aria-label="Conversation information"]',
            ...
            async with async_playwright() as pw:
                ...
                for i in range(150):
                    ...
                    if is_locker and i > 0 and i % 19 == 0:
                        ...
                        # re-fetch mbox — DOM shifts after panel close
                        mbox = page.locator(
                            'div[role="textbox"], div[aria-label="Message"]'
                        ).first
                        await mbox.click(timeout=5000)
