...
def professional_banner():
    ...
    \033[95m    ██║██║ ╚████║╚██████╔╝███████║╚██████╔╝██║  ██╗███████╗
    \033[0m
    \033[1;37m        🔱  InosukexGOD | THE ABSOLUTE KING 👑
    \033[1;31m        --------------------------------------------
    \033[1;33m  DEVELOPER : Inosuke
...
STRIKE_MESSAGES = [
    ...
    "[{target}] 𝐈𝐍𝐎𝐒𝐔𝐊𝐄 𝐒𝐈𝐃𝐄 𝐀𝐂𝐓𝐈𝐕𝐄 अब रोने का अलावा कोई रास्ता नहीं🤣🔥 "
    "꧁𓊈𒆜 𝙄𝙉𝙊𝙎𝙐𝙆𝙀 भगवान है👑 𒆜𓊉꧂ "
]
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                for _ in range(150):
                    ...
                    print(f"    \033[1;37m[E-{engine_id}] [{status}] STRIKE: {msg_count} | BY 𝙄𝙉𝙊𝙎𝙐𝙆𝙀xGOD\033[0m")
...
async def main():
    professional_banner()
    choice = input("\033[1;37m    🔱 USE DEFAULT SETTINGS BY InosukexGOD ? (y/n): \033[0m").strip().lower()
...
if __name__ == "__main__":
    try:
        ...
        print("\033[1;31m   👑INOSUKE GOD STOPPED BY USER. CLEANING CACHE... \033[0m")
        sys.exit()
