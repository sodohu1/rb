...
LOG_LEVEL: str = "INFO"
DEFAULT_SUPPORT_URL: str = "https://t.me/SODOHelpbot"
    ...
    for member in new_members:
        ...
        try:
            ...
            welcome_text = group["welcome_text"] or (
                ...
                f"𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑻𝑯𝑬 𝑮𝑪 🫀✨\n"
                f"╰─── 𓆩♡𓆪 ───╯\n\n"
                f"👋🏻 𝑯𝒆𝒚𝒚, <b>{display_name}</b> — 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒉𝒆𝒓𝒆! 🫶🏻\n\n"
                f"✨ 𝑪𝒐𝒎𝒆 𝒊𝒏, 𝒔𝒕𝒂𝒚 𝒄𝒐𝒎𝒇𝒚\n"
                f"😂 𝑳𝒂𝒖𝒈𝒉 • 𝑪𝒉𝒊𝒍𝒍 • 𝑽𝒊𝒃𝒆\n"
                f"🫂 𝑴𝒂𝒌𝒆 𝒔𝒐𝒎𝒆 𝒈𝒐𝒐𝒅 𝒎𝒆𝒎𝒐𝒓𝒊𝒆𝒔\n"
                f"💬 𝑨𝒏𝒅 𝒅𝒐𝒏'𝒕 𝒃𝒆 𝒔𝒉𝒚 — 𝒋𝒐𝒊𝒏 𝒕𝒉𝒆 𝒄𝒉𝒂𝒕! 😭🔥\n\n"
                f"💫 𝑮𝒍𝒂𝒅 𝒕𝒐 𝒉𝒂𝒗𝒆 𝒚𝒐𝒖 𝒉𝒆𝒓𝒆!\n"
                f"𝑵𝒐𝒘 𝒚𝒐𝒖'𝒓𝒆 𝒑𝒂𝒓𝒕 𝒐𝒇 𝒕𝒉𝒆 𝒈𝒂𝒏𝒈 ♾️🫀\n\n"
                f"╰┈➤ 𝑬𝒏𝒋𝒐𝒚 𝒕𝒉𝒆 𝒗𝒊𝒃𝒆𝒔! 🦋✨\n\n"
